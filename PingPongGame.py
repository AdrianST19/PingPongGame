...
# First we score the varibales
player_a_score = 0
player_b_score = 0

win = t.Screen()  # creating a window
win.title("Ping-Pong Game")  # giving a name to the game.
...
pen.hideturtle()
pen.goto(0, 260)
pen.write("First player: 0                          Second player: 0 ",
...
while True:
    ...
    if ball.xcor() > 390:   # right width paddle Border
        ...
        pen.clear()
        pen.write("First player: {}                          Second player: {} ".format(
            player_a_score, player_b_score), align="center", font=('Times New Roman', 24, "normal"))
